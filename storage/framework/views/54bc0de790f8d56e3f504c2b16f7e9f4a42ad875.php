    ...
    <div class="container-fluid py-4">
        <div class="row my-4">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Cari Barang Keluar</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Gudang*</label>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $barang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $br): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" href="#Barang" wire:click='hapusBarang(<?php echo e($br->id); ?>)'><i class="text-white">batalkan</i></a>
                                </td>
                            </tr>
...
<?php /**PATH F:\MyApplications\Inventaris_Fajar\resources\views/livewire/admin/barang/barang-keluar-component.blade.php ENDPATH**/ ?>